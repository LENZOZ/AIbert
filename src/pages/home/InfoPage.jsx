        ...
        <div className="mt-24 mx-auto">
          <div className="container lg:flex md:flex sm:block items-center bg-gradient-to-t from-sky-500 to-indigo-500 w-[80vw]  px-5 py-8 lg:py-14 md:py-14 rounded-lg text-white">
            <div className="lg,md,xl:w-[45%] w-[100%]  p-8">
              ...
              <p className="font-poppins text-base font-medium text-center justify-center mt-10">
              ...
              <p className="font-poppins text-base font-medium text-center justify-center mt-3">
                Imagina tener a Aibert como tu tutor personal. Esta inteligencia
                artificial analiza tus fortalezas y debilidades matemáticas,
                creando ejercicios personalizados que se ajustan a tus
                necesidades individuales. Aibert maximiza tu tiempo de estudio,
                centrándose en las áreas que necesitan mayor desarrollo.
              </p>
              </div>
              <h2 className="font-poppins text-2xl font-bold text-center mt-10">
